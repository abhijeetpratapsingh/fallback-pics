...
export const blogPosts: BlogPost[] = [
  {
    ...
    image:
      "https://fallback.pics/api/v1/thumbnail/1200x630?text=Generate+Blog+Thumbnails+from+Text&style=soft&label=Guide",
    date: "2026-06-06",
    readTime: "8 min read",
    category: "API Guides",
    tags: [
    ...
    sections: [
      {
        eyebrow: "Use case",
        title: "A fallback for missing blog featured images",
        body: [
          "A missing featured image can make a blog index, CMS preview, social card, or related-post module look unfinished. The thumbnail route gives teams a predictable visual fallback generated from the post title.",
          "Unlike a generic dimensions placeholder, a thumbnail is designed like a blog card: large readable title, short category label, gradient theme, and decorative elements constrained to the right side and corners.",
        ],
      },
      {
        eyebrow: "Basic URL",
        title: "Generate a thumbnail from a title",
        body: [
        ...
        code: `https://fallback.pics/api/v1/thumbnail/1200x630?text=How+to+Fix+Broken+Images`,
      },
      {
        eyebrow: "Controls",
        title: "Choose style, theme, and category label",
        body: [
        ...
        code: `https://fallback.pics/api/v1/thumbnail/1200x630?text=React+Image+Fallback+Patterns&style=soft&theme=blue&label=Tutorial
...
https://fallback.pics/api/v1/thumbnail/1200x630?text=Prevent+Layout+Shift+From+Missing+Images&style=lines&theme=dark&label=Performance`,
      ...
      {
        eyebrow: "Safe zone",
        title: "Keep decoration away from the headline",
        body: [
        ...
        cards: [
          {
            title: "Text zone",
            body: "The label and title stay in a reserved left-side region with high contrast.",
          },
          {
            title: "Decoration zone",
            body: "Background shapes, rings, lines, and patterns are placed on the right side and outer corners.",
          },
          {
            title: "Deterministic output",
            body: "The title and optional seed control the variation so the same URL produces the same thumbnail.",
          },
        ],
      },
      {
        eyebrow: "Custom colors",
        title: "Use custom gradients and accents",
        body: [
        ...
        code: `https://fallback.pics/api/v1/thumbnail/1200x630?text=Fix+Broken+Images+in+HTML&style=soft&label=Guide&bg=7C3AED,3B82F6&accent=F97316&color=FFFFFF`,
      },
      {
        eyebrow: "Implementation",
        title: "Use it in a CMS or blog template",
        body: [
        ...
        code: `const image = post.featuredImage ??
  ...
  new URLSearchParams({
    ...
    takeaways: [
      "Use /api/v1/thumbnail/1200x630 for blog featured image fallbacks.",
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Placeholder+Image+API",
    date: "2026-06-05",
        ...
        cards: [
          {
            ...
            body: "Use one image URL anywhere an img src, CSS background, Markdown image, or CMS media URL is accepted.",
          },
          {
            title: "Production states",
            body: "Use placeholders for mockups and fallback images for real missing or failed media.",
          },
          {
            title: "Deterministic output",
            body: "Stable URLs are easier to cache, test, log, and reuse across repeated UI surfaces.",
          },
        ],
      },
      {
...
Next.js guide: https://fallback.pics/guides/nextjs-image-fallback/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=HTML+Image+Fallback",
    date: "2026-06-05",
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Product grids",
            body: "Replace missing catalog photos without collapsing card height or pushing prices out of alignment.",
          },
          {
            title: "CMS previews",
            body: "Keep editorial previews usable when a media field is empty or a remote asset has been removed.",
          },
          {
            title: "Dashboards",
            body: "Use consistent report, user, and workspace preview states instead of browser broken-image icons.",
          },
        ],
      },
      {
...
Next.js guide: https://fallback.pics/guides/nextjs-image-fallback/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=React+Image+Fallback",
    date: "2026-06-05",
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Missing src",
            body: "Use the fallback URL before render when the API, CMS, or product record has no image value.",
          },
          {
            title: "Failed load",
            body: "Use onError when the browser receives a URL but the resource fails, times out, or returns unusable image data.",
          },
          {
            title: "Stable UI",
            body: "Keep width, height, and aspect ratio consistent so the fallback does not introduce layout shift.",
          },
        ],
      },
      {
...
API reference: https://fallback.pics/api/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Next.js+Image+Fallback",
    date: "2026-06-05",
        ...
        cards: [
          {
            ...
            body: "Use a fallback URL before rendering Image when CMS or product data has no usable src.",
          },
          {
            title: "Failed remote loads",
            body: "Use a client component and state guard when an image URL exists but fails after render.",
          },
          {
            title: "CLS control",
            body: "Keep width, height, fill container, and aspect ratio stable when swapping to the fallback.",
          },
        ],
      },
      {
...
API reference: https://fallback.pics/api/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Placeholder+vs+Dummy+Image",
    date: "2026-06-05",
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Dummy image",
            body: "A stand-in asset for mockups, fixtures, demos, seed data, and unfinished designs.",
          },
          {
            title: "Placeholder image",
            body: "A predictable visual that reserves space and communicates the intended image surface.",
          },
          {
            title: "Fallback image",
            body: "A production replacement shown when expected media is missing, invalid, blocked, or failed.",
          },
        ],
      },
      {
...
/>`,
      },
      {
        ...
        cards: [
          {
            title: "Mockup",
            body: "Use Dummy Image, Preview, Hero Mockup, or Card Image labels in fixtures and design demos.",
          },
          {
            title: "Layout",
            body: "Use exact dimensions and aspect ratios for cards, banners, avatars, grids, and docs.",
          },
          {
            title: "Production",
            body: "Use clear missing-media labels and attach fallbacks in HTML, React, Next.js, or shared components.",
          },
        ],
      },
      {
...
Next.js guide: https://fallback.pics/guides/nextjs-image-fallback/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Best+Placeholder+Image+APIs",
    date: "2026-06-05",
    readTime: "13 min read",
    category: "Comparisons",
    tags: [
      "Best placeholder image API",
      "Placeholder image API",
        ...
        cards: [
          {
            ...
            body: "Use deterministic URLs, stable dimensions, and generic labels like Product Image or Image Unavailable.",
          },
          {
            title: "Visual mockup",
            body: "Use photo or decorative placeholders when realistic-looking design comps matter more than deterministic state messaging.",
          },
          {
            title: "Developer fixtures",
            body: "Use short, copyable URLs that work in HTML, React, Next.js, Markdown, test data, and docs.",
          },
        ],
      },
      {
        ...
        cards: [
          {
            title: "fallback.pics",
            body: "Best fit for deterministic SVG placeholders, broken-image fallbacks, avatars, skeleton states, docs, and framework examples using /api/v1 URLs.",
          },
          {
            title: "placehold.co",
            body: "Best fit for familiar URL placeholders with dimensions, formats, colors, text, fonts, and retina variants.",
          },
          {
            title: "DummyImage",
            body: "Best fit for classic dummy image URLs with dimensions, colors, ratios, and custom text in a long-standing format.",
          },
          {
            title: "Picsum Photos",
            body: "Best fit for random or seeded photo placeholders when realistic photography is useful in mockups.",
          },
          {
            title: "MockImg",
            body: "Best fit for highly customizable generated placeholders with many formats, fonts, icons, gradients, and visual effects.",
          },
        ],
      },
      {
...
https://fallback.pics/api/v1/animated/skeleton/600x400`,
      },
      {
        ...
        cards: [
          {
            title: "URL syntax",
            body: "Can the team remember and copy the route without custom helper code?",
          },
          {
            title: "Determinism",
            body: "Does the same URL produce the same state when tests, docs, or production fallbacks rely on it?",
          },
          {
            title: "Privacy",
            body: "Can you use generic labels without exposing user names, emails, tokens, account IDs, or order numbers?",
          },
          {
            title: "Framework fit",
            body: "Does the URL work cleanly in HTML, React, Next.js, CMS fields, and docs?",
          },
        ],
      },
      {
...
Next.js guide: https://fallback.pics/guides/nextjs-image-fallback/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=placehold.co+Alternatives",
    date: "2026-06-05",
    readTime: "12 min read",
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Mockup need",
            body: "A temporary image while design, layout, or test data is unfinished.",
          },
          {
            title: "Fallback need",
            body: "A controlled visual state when real media is expected but unavailable.",
          },
          {
            title: "System need",
            body: "A repeatable rule for HTML, React, Next.js, CMS previews, docs, and screenshot tests.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        cards: [
          {
            title: "Determinism",
            body: "Will the same placeholder URL work predictably in QA, docs, screenshots, and production fallbacks?",
          },
          {
            title: "Context",
            body: "Can you create different placeholders for product images, avatars, banners, skeletons, and unavailable media?",
          },
          {
            title: "Implementation",
            body: "Are there clear examples for HTML onerror, React onError, and Next.js image fallback behavior?",
          },
          {
            title: "Privacy",
            body: "Can the team avoid putting user names, emails, order numbers, account IDs, or tokens into URL text?",
          },
        ],
      },
      {
...
/>`,
      },
      {
        ...
        cards: [
          {
            title: "DummyImage",
            body: "Classic dummy image URL syntax for dimensions, colors, ratios, and text.",
          },
          {
            title: "Picsum Photos",
            body: "Random or seeded photo placeholders for realistic mockups.",
          },
          {
            title: "MockImg",
            body: "Highly customizable generated placeholders with broad styling controls.",
          },
          {
            title: "fallback.pics",
            body: "Deterministic SVG fallback states and implementation-focused developer docs.",
          },
        ],
      },
      {
...
Next.js guide: https://fallback.pics/guides/nextjs-image-fallback/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=DummyImage+Alternatives",
    date: "2026-06-05",
    readTime: "12 min read",
    category: "Alternatives",
    tags: [
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Mockups",
            body: "Use simple dummy image URLs while layout, copy, and final assets are unfinished.",
          },
          {
            title: "Fixtures",
            body: "Use deterministic URLs in seed data, Storybook examples, screenshots, docs, and tests.",
          },
          {
            title: "Fallbacks",
            body: "Use contextual placeholders when real product, avatar, CMS, or remote images are missing.",
          },
        ],
      },
      {
...
/>`,
      },
      {
        ...
        cards: [
          {
            title: "DummyImage",
            body: "Classic dimensions-first dummy image URLs with colors, formats, ratios, and text.",
          },
          {
            title: "MockImg",
            body: "Rich generated placeholders with broader visual controls and many output options.",
          },
          {
            title: "Picsum-style services",
            body: "Photo placeholders when realistic visuals matter more than state messaging.",
          },
          {
            title: "fallback.pics",
            body: "Deterministic SVG placeholders for mockups, docs, avatars, skeletons, and fallback states.",
          },
        ],
      },
      {
...
Next.js guide: https://fallback.pics/guides/nextjs-image-fallback/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Lorem+Picsum+vs+SVG",
    date: "2026-06-05",
    readTime: "12 min read",
    category: "Comparisons",
    tags: [
      "Lorem Picsum alternative",
      "Picsum Photos alternative",
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Random photo placeholder",
            body: "Good for visual mockups, galleries, and prototypes where realistic photography helps the design feel populated.",
          },
          {
            title: "Seeded photo placeholder",
            body: "Good when you want a stable photo result but still want photographic content.",
          },
          {
            title: "SVG placeholder image",
            body: "Good for explicit fallback states, product surfaces, docs, dashboards, and screenshot tests.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        cards: [
          {
            title: "Wrong context",
            body: "A random photo may visually conflict with the product, document, avatar, or report it represents.",
          },
          {
            title: "False confidence",
            body: "A realistic image can hide missing-media problems in QA and stakeholder reviews.",
          },
          {
            title: "Unstable tests",
            body: "Random image changes can make screenshot reviews noisy unless every image is pinned by ID or seed.",
          },
        ],
      },
      {
        ...
        cards: [
          {
            ...
            body: "Photo placeholders can help evaluate composition, cropping, and visual weight.",
          },
          {
            title: "Product catalog",
            body: "Use Product Image or Image Unavailable so missing supplier media is obvious.",
          },
          {
            title: "Docs and tutorials",
            body: "Use labeled SVG placeholders so readers understand the intended image role.",
          },
          {
            title: "Visual regression tests",
            body: "Use deterministic URLs so screenshots are easier to compare.",
          },
        ],
      },
      {
...
Next.js guide: https://fallback.pics/guides/nextjs-image-fallback/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Product+Image+Placeholder",
    date: "2026-06-05",
    readTime: "12 min read",
    category: "Ecommerce",
    tags: [
        ...
        cards: [
          {
            ...
            body: "Supplier feeds, CSV imports, PIM exports, and marketplace syncs can create products before photos are ready.",
          },
          {
            title: "Failed remote URLs",
            body: "Old CDN paths, expired signed URLs, deleted source files, or format support issues can break images after products go live.",
          },
          {
            title: "Incomplete variants",
            body: "A parent product may have media while color, size, bundle, or marketplace-specific variants are missing their own image.",
          },
        ],
      },
      {
        ...
        cards: [
          {
            ...
            body: "Use a square or catalog-ratio image that matches the final product card crop.",
          },
          {
            title: "Product detail media",
            body: "Use a larger square or portrait placeholder so the gallery does not resize when a source image fails.",
          },
          {
            title: "Cart and checkout thumbnail",
            body: "Use smaller fallback URLs with generic labels so totals and checkout actions stay aligned.",
          },
          {
            title: "Admin preview",
            body: "Use explicit labels like Product Image or Image Missing so data issues are visible before publish.",
          },
        ],
        code: `// Product grid
https://fallback.pics/api/v1/800x800/F4F4F5/18181B?text=Product+Image
        ...
        cards: [
          {
            ...
            body: "Flag products created without primary media before they are published.",
          },
          {
            title: "CDN monitoring",
            body: "Log repeated image load failures so broken source paths can be corrected.",
          },
          {
            title: "Merchandising QA",
            body: "Review placeholder-heavy categories before campaigns, launches, and feed exports.",
          },
        ],
      },
      {
...
// Avoid putting private values in placeholder URL text`,
      },
      {
        ...
        cards: [
          {
            title: "Audit image surfaces",
            body: "List every product image size and ratio before choosing fallback URLs.",
          },
          {
            title: "Define labels",
            body: "Use Product Image, Product, Image Missing, or Image Unavailable rather than data-rich labels.",
          },
          {
            title: "Add component tests",
            body: "Test empty src and failed load paths in your product image component.",
          },
          {
            title: "Monitor usage",
            body: "Treat fallback usage as a content-quality signal, not just a frontend fix.",
          },
        ],
      },
      {
...
Dummy image generator: https://fallback.pics/dummy-image-generator/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Prevent+Image+Layout+Shift",
    date: "2026-06-05",
    readTime: "11 min read",
        ...
        cards: [
          {
            ...
            body: "The image eventually appears, but the page had no reserved height while it was downloading.",
          },
          {
            title: "Failed image URL",
            body: "The real image never appears, and the browser broken-image state leaves an unstable or inconsistent slot.",
          },
          {
            title: "Missing image src",
            body: "The product, avatar, article, or CMS record has no media URL, so the component renders without a stable box.",
          },
        ],
      },
      {
  ...
  />
      ...
      },
      {
        ...
        cards: [
          {
            title: "Loading state",
            body: "Use a skeleton or neutral placeholder while the data or image request is still pending.",
          },
          {
            title: "Missing state",
            body: "Use a labeled fallback such as Image Unavailable, Product Image, Article Image, or User.",
          },
          {
            title: "Error state",
            body: "Swap to the fallback inside the same slot after onerror, framework error state, or CDN failure detection.",
          },
        ],
      },
      {
        ...
        cards: [
          {
            title: "Unsized img",
            body: "The image has no width and height attributes and no stable CSS aspect ratio.",
          },
          {
            title: "Conditional wrapper",
            body: "The component renders no media box until image data exists.",
          },
          {
            title: "Mismatched fallback",
            body: "The fallback image has a different ratio from the real image slot.",
          },
          {
            title: "Framework fill misuse",
            body: "The image uses fill, but the parent container has no stable dimensions.",
          },
        ],
      },
      {
...
Product image placeholder: https://fallback.pics/product-image-placeholder/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Skeleton+vs+Fallback",
    date: "2026-06-05",
    readTime: "11 min read",
        ...
        cards: [
          {
            ...
            body: "Use while content, product data, avatars, thumbnails, or article cards are still loading.",
          },
          {
            title: "Static fallback image",
            body: "Use after an image src is empty, invalid, blocked, deleted, or fails to load.",
          },
          {
            title: "Neutral placeholder",
            body: "Use for mockups, seed data, documentation examples, or reserved layout slots.",
          },
        ],
      },
      {
        ...
        cards: [
          {
            ...
            body: "Use a skeleton or loading placeholder that mirrors the final content shape.",
          },
          {
            title: "Image request pending",
            body: "Use a reserved image slot, optional low-key skeleton, and stable dimensions.",
          },
          {
            title: "Source URL missing",
            body: "Render a static fallback immediately instead of a loader.",
          },
          {
            title: "Image load failed",
            body: "Swap to a static fallback inside the same reserved slot.",
          },
        ],
      },
      {
    ...
    animation: none;
      ...
      },
      {
        ...
        cards: [
          {
            title: "Wrong",
            body: "A product image skeleton remains visible because the product has no image.",
          },
          {
            title: "Better",
            body: "The product image slot switches to a Product Image fallback once the missing-media state is known.",
          },
          {
            title: "Wrong",
            body: "Every card shows an animated shimmer even when content is already available in HTML.",
          },
          {
            title: "Better",
            body: "Skeletons only render for pending client-side or lazy-loaded content.",
          },
        ],
      },
      {
...
Product image placeholder: https://fallback.pics/product-image-placeholder/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Avatar+Placeholder+Guide",
    date: "2026-06-05",
    readTime: "11 min read",
    category: "UX Patterns",
    tags: [
        ...
        cards: [
          {
            ...
            body: "The user never uploaded an image, deleted it, or joined before profile setup was complete.",
          },
          {
            title: "Failed remote avatar",
            body: "The avatar URL exists but fails because of CDN, permissions, moderation, migration, or format issues.",
          },
          {
            title: "Seed and demo data",
            body: "Test accounts, screenshots, docs, and staging environments need stable user visuals without real photos.",
          },
        ],
      },
      {
        ...
        cards: [
          {
            ...
            body: "Good for names with clear first and last parts, such as JD or AP.",
          },
          {
            title: "One-letter fallback",
            body: "Useful for compact interfaces or accounts with one display-name token.",
          },
          {
            title: "Generic fallback",
            body: "Use User, Team, or Member when identity should not be encoded in the URL.",
          },
        ],
...
<span>Jane Doe</span>`,
      },
      {
        ...
        cards: [
          {
            title: "32-40px",
            body: "Dense tables, assignee chips, compact menus, and message metadata.",
          },
          {
            title: "48-64px",
            body: "Comments, activity feeds, team lists, and user search results.",
          },
          {
            title: "96-200px",
            body: "Profile settings, account pages, member cards, and documentation examples.",
          },
        ],
      },
      {
...
Placeholder image API: https://fallback.pics/placeholder-image-api/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=SVG+Placeholder+Images",
    date: "2026-06-05",
    readTime: "12 min read",
    category: "Technical",
    tags: [
        ...
        cards: [
          {
            ...
            body: "The same URL can return the same placeholder for product, avatar, article, docs, or unavailable-image surfaces.",
          },
          {
            title: "Resolution independence",
            body: "Vector output can scale across common display densities without generating separate 1x, 2x, and 3x raster files.",
          },
          {
            title: "Readable parameters",
            body: "Dimensions, colors, and labels can be expressed in the URL and reused across HTML, React, Next.js, docs, and tests.",
          },
        ],
      },
      {
...
https://fallback.pics/api/v1/800x800?text=Product+Image`,
      },
      {
        ...
        cards: [
          {
            title: "Good SVG fit",
            body: "Solid backgrounds, labels, avatar initials, skeleton blocks, diagrams, icons, and UI-like fallback states.",
          },
          {
            title: "Poor SVG fit",
            body: "Photographs, detailed textures, realistic product photos, and complex illustrations that should use raster formats.",
          },
          {
            title: "Best practice",
            body: "Keep generated placeholder SVGs simple enough to cache, inspect, and render quickly.",
          },
        ],
      },
      {
...
Content-Type: image/svg+xml`,
      },
      {
        ...
        cards: [
          {
            title: "Good cache behavior",
            body: "Repeated URLs for common surfaces such as 800x800 Product Image or 1200x630 Article Image.",
          },
          {
            title: "Poor cache behavior",
            body: "Unique URLs per user, request, product name, error id, timestamp, or session.",
          },
          {
            title: "Operational rule",
            body: "Use generic labels and a small set of standard dimensions for production fallback states.",
          },
        ],
      },
      {
...
Skeleton placeholder generator: https://fallback.pics/skeleton-placeholder-generator/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Cache-Control+for+Placeholders",
    date: "2026-06-05",
    readTime: "12 min read",
    category: "Technical",
    tags: [
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Browser cache",
            body: "Avoid repeat downloads for the same placeholder during page navigation and revisits.",
          },
          {
            title: "CDN cache",
            body: "Serve common fallback images from edge locations instead of repeatedly invoking origin generation.",
          },
          {
            title: "Operational control",
            body: "Keep cache keys bounded so analytics, logs, and cache storage stay manageable.",
          },
        ],
      },
      {
...
Content-Type: image/svg+xml`,
      },
      {
        ...
        cards: [
          {
            title: "public",
            body: "Use for generic placeholder images that are safe for browser and shared cache storage.",
          },
          {
            title: "max-age",
            body: "Use a long value for deterministic URLs and shorter values for outputs that may change.",
          },
          {
            title: "immutable",
            body: "Use only when a changed image will use a changed URL.",
          },
          {
            title: "no-store",
            body: "Use when a response contains private or sensitive data; placeholder URLs should avoid that data.",
          },
        ],
      },
      {
...
# CF-Cache-Status or equivalent CDN cache status`,
      },
      {
        ...
        cards: [
          {
            title: "Bad cache key",
            body: "A placeholder URL that includes a user name, account id, timestamp, or request id.",
          },
          {
            title: "Better cache key",
            body: "A generic label such as User, Product Image, Article Image, Preview, or Image Unavailable.",
          },
          {
            title: "Bad header match",
            body: "public immutable caching on a response that can change without a URL change.",
          },
          {
            title: "Better header match",
            body: "Long caching only for deterministic URLs where the URL is the version.",
          },
        ],
      },
      {
...
Skeleton placeholder generator: https://fallback.pics/skeleton-placeholder-generator/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Self-Hosted+Placeholder+API",
    date: "2026-06-05",
    readTime: "13 min read",
    category: "Technical",
    tags: [
      "Self hosted placeholder image API",
      "Cloudflare Workers image API",
      "SVG placeholder API",
      "Build placeholder image API",
    ],
    summary: [
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Self-host when",
            body: "You need internal-only infrastructure, custom routing, strict platform ownership, or a learning project.",
          },
          {
            title: "Use fallback.pics when",
            body: "You want copy-paste placeholder URLs without maintaining a Worker, cache policy, docs, and abuse controls.",
          },
          {
            title: "Hybrid path",
            body: "Use fallback.pics in product apps and keep a tiny self-hosted worker for experiments or internal tooling.",
          },
        ],
      },
      {
...
// Avoid request-specific URL text`,
      },
      {
        ...
        cards: [
          {
            title: "Reliability",
            body: "Fallback images should be boring and available because they appear when other media fails.",
          },
          {
            title: "Compatibility",
            body: "Document how URLs work in img tags, Markdown, CMS fields, React components, and Next.js images.",
          },
          {
            title: "Abuse prevention",
            body: "Limit dimensions, text length, request methods, formats, and dynamic input surface.",
          },
          {
            title: "Observability",
            body: "Track error rates, top routes, cache misses, and unexpected high-cardinality query patterns.",
          },
        ],
      },
      {
        ...
        cards: [
          {
            title: "Choose self-hosting",
            body: "For internal-only networks, custom compliance requirements, unusual routing, or platform-learning projects.",
          },
          {
            title: "Choose fallback.pics",
            body: "For production fallback states, docs, demos, tests, product placeholders, avatars, and quick integration.",
          },
          {
            title: "Use both",
            body: "Prototype self-hosting while keeping fallback.pics as the stable implementation path for product surfaces.",
          },
        ],
      },
      {
...
Next.js image fallback: https://fallback.pics/guides/nextjs-image-fallback/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Test+Placeholder+Images",
    date: "2026-06-05",
    readTime: "12 min read",
    category: "Testing",
    tags: [
        ...
        cards: [
          {
            ...
            body: "The same placeholder renders across local runs, CI, branches, and baseline updates.",
          },
          {
            title: "Layout coverage",
            body: "Cards, avatars, grids, banners, and media slots still exercise real dimensions and aspect ratios.",
          },
          {
            title: "Readable state",
            body: "Labels such as Product Image, User, Article Image, or Preview explain what the slot represents.",
          },
        ],
      },
      {
        ...
        cards: [
          {
            ...
            body: "Mock API data, image URLs, dates, locale, theme, and feature flags before taking screenshots.",
          },
          {
            title: "Freeze media",
            body: "Use deterministic placeholders for image slots that are not the subject of the test.",
          },
          {
            title: "Assert the right thing",
            body: "Use visual snapshots for layout and appearance, not unpredictable remote content.",
          },
        ],
      },
      {
...
Cache-Control guide: https://fallback.pics/blog/cache-control-placeholder-images-cdn-browser/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=CSS+Background+Fallbacks",
    date: "2026-06-05",
    readTime: "11 min read",
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "CSS can layer backgrounds",
            body: "Multiple background images can be stacked, with the first listed layer painted on top.",
          },
          {
            title: "CSS can provide a color",
            body: "A background color gives the element a visible base even when the image is unavailable.",
          },
          {
            title: "CSS cannot handle errors",
            body: "There is no background-image onerror event equivalent in CSS.",
          },
        ],
      },
      {
  ...
  background-repeat: no-repeat, no-repeat;
      ...
      },
      {
        ...
        cards: [
          {
            title: "No error event",
            body: "CSS cannot run fallback logic when a background URL returns 404 or fails to decode.",
          },
          {
            title: "No alt text",
            body: "Background images are not content images and do not provide image alt text.",
          },
          {
            title: "No retry state",
            body: "You cannot switch from loading to failed to fallback with CSS alone.",
          },
        ],
      },
      {
...
SVG placeholder images: https://fallback.pics/blog/svg-placeholder-images-fast-cacheable-scalable/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Responsive+Placeholders",
    date: "2026-06-05",
    readTime: "12 min read",
    category: "Implementation",
    tags: [
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Cards",
            body: "Use 16:9, 4:3, or square fallbacks that match the card design.",
          },
          {
            title: "Banners",
            body: "Use wide fallbacks that reserve the hero or campaign slot without pushing content around.",
          },
          {
            title: "Grids",
            body: "Use one ratio per repeated row so missing media does not make tiles uneven.",
          },
        ],
      },
      {
...
Skeleton placeholders: https://fallback.pics/blog/skeleton-placeholder-images-vs-static-fallbacks/`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=OG+Image+Placeholders",
    date: "2026-06-05",
    readTime: "11 min read",
...
https://fallback.pics/api/v1/1200x630/F4F4F5/18181B?text=Documentation`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=CMS+Media+Placeholders",
    date: "2026-06-05",
    readTime: "12 min read",
...
https://fallback.pics/api/v1/banner/1200x400/F4F4F5/18181B?text=Collection`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Mobile+Image+Fallbacks",
    date: "2026-06-05",
    readTime: "13 min read",
    category: "Mobile UX",
    tags: [
...
function MobileCardImage({ imageUrl }) {
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Privacy-Safe+Placeholders",
    date: "2026-06-05",
    readTime: "11 min read",
    category: "Trust",
    tags: [
      "Privacy placeholder image API",
      "Safe placeholder image",
      "No upload placeholder image",
...
/>`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/7C3AED/FFFFFF?text=Branded+Fallbacks",
    date: "2026-06-05",
    readTime: "12 min read",
    category: "SaaS",
    tags: [
...
https://fallback.pics/api/v1/800x600/F4F4F5/18181B?text=File+Preview`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Fallback+Rollout+Checklist",
    date: "2026-06-05",
    readTime: "13 min read",
    category: "Implementation",
    tags: [
      "Broken image fallback",
      "Broken image icon",
      "Fallback image checklist",
      "Image fallback rollout",
    ],
    summary: [
...
/>`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Image+Placeholder+Guide",
    date: "2025-01-15",
        ...
        cards: [
          {
            ...
            body: "Reserve aspect ratio and prevent content shift across dense grids and feeds.",
          },
          {
            title: "Perceived speed",
            body: "Show an intentional loading or fallback state while real media catches up.",
          },
          {
            title: "Brand control",
            body: "Replace browser broken-image chrome with a consistent, production-safe visual.",
          },
        ],
      },
      {
...
/>`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Fallback+Image+Case+Studies",
    date: "2025-01-15",
    readTime: "12 min read",
        ...
        cards: [
          {
            ...
            body: "Product grids remain scannable even when vendor assets are incomplete.",
          },
          {
            title: "Conversion protection",
            body: "A controlled fallback is less disruptive than a broken image icon.",
          },
        ],
      },
      {
...
/>`,
  ...
  },
  {
    ...
    image:
      "https://fallback.pics/api/v1/1200x630/18181B/FFFFFF?text=Image+Loading+Best+Practices",
    date: "2025-01-15",
