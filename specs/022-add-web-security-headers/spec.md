# Feature Specification: Add Web Security Headers

## Source Story

Source story file: specs/22-add-web-security-headers.md

## User Value

Add Cloudflare Pages security headers for web HTML responses while preserving image API behavior and static file content types.
