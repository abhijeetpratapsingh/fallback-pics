# HTTP Validation Contract: Align Canonical and Sitemap URLs

## Public URL Truth

/placeholder-image-api/ canonical self URL; /dummy-image-generator/ canonical self URL; /broken-image-fallback/ canonical self URL
