# Implementation Plan: Align Canonical and Sitemap URLs

**Branch**: `003-align-canonical-sitemap` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/003-align-canonical-sitemap/spec.md`

## Summary

Implement canonical sitemap alignment by updating apps/web/src/pages/[...slug].astro, apps/web/src/layouts/Layout.astro, apps/web/public/sitemap.xml and validating public URL truth.
...
- **Public URL Truth**: /placeholder-image-api/ canonical self URL; /dummy-image-generator/ canonical self URL; /broken-image-fallback/ canonical self URL. Validation commands are listed in quickstart.md and contracts/http-validation.md.
...
```text
specs/003-align-canonical-sitemap/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
