# Implementation Plan: Strengthen Placeholder Image API Page

**Branch**: `006-strengthen-placeholder-api-page` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/006-strengthen-placeholder-api-page/spec.md`

## Summary

Implement placeholder api page by updating apps/web/src/data/seoPages.ts, apps/web/src/pages/[...slug].astro, apps/web/src/layouts/ContentLayout.astro and validating public URL truth.
...
- **Public URL Truth**: /placeholder-image-api/ => 200 text/html self canonical; example URLs => /api/v1 image/svg+xml. Validation commands are listed in quickstart.md and contracts/http-validation.md.
...
```text
specs/006-strengthen-placeholder-api-page/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
