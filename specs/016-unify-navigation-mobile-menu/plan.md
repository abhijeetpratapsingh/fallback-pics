# Implementation Plan: Unify Navigation and Mobile Menu

**Branch**: `016-unify-navigation-mobile-menu` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/016-unify-navigation-mobile-menu/spec.md`

## Summary

Implement unify navigation and mobile menu.
...
- **Public URL Truth**: /; /docs/; /api/; /placeholder-image-generator/.
...
```text
specs/016-unify-navigation-mobile-menu/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
