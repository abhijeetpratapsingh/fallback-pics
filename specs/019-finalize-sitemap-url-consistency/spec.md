# Feature Specification: Finalize Sitemap URL Consistency

## Source Story

Source story file: specs/19-finalize-sitemap-url-consistency.md

## User Value

Make sitemap entries use final canonical trailing-slash HTML URLs, preserve /api/v1 image entries, and validate XML plus canonical matching.
