# Implementation Plan: Fix Soft 404 Routing

**Branch**: `001-fix-soft-404-routing` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/001-fix-soft-404-routing/spec.md`

## Summary

Implement soft-404 routing by updating apps/web/src/pages/404.astro, apps/web/src/layouts/Layout.astro, apps/web/src/pages/[...slug].astro and validating public URL truth.
...
- **Public URL Truth**: /not-a-real-seo-test-page => 404 text/html noindex; /placeholder-image-api/ => 200 text/html canonical self URL; /api/v1/400x300 => 200 image/svg+xml immutable cache. Validation commands are listed in quickstart.md and contracts/http-validation.md.
...
```text
specs/001-fix-soft-404-routing/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
