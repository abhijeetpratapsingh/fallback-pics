# Implementation Plan: Improve Trust Signals

**Branch**: `010-improve-trust-signals` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/010-improve-trust-signals/spec.md`

## Summary

Implement trust signals by updating apps/web/src/pages/api.astro, apps/web/src/pages/docs.astro, apps/web/src/pages/privacy.astro and validating public URL truth.
...
- **Public URL Truth**: /api => headers and error behavior; /docs => trust signals; /privacy => no-cookie delivery posture; https://status.fallback.pics external trust link. Validation commands are listed in quickstart.md and contracts/http-validation.md.
...
```text
specs/010-improve-trust-signals/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
