# Feature Specification: Add Placeholder Image Generator Page

**Feature Branch**: `009-placeholder-image-generator-page`

**Created**: 2026-06-03

**Status**: Implemented

**Input**: Source story converted from `specs/09-add-placeholder-image-generator-page.md`

## User Scenarios & Testing *(mandatory)*

### User Story 1 - Add Placeholder Image Generator Page (Priority: P1)
...
**Why this priority**: This page owns direct generator intent and connects API examples to copyable output.
...
- /placeholder-image-generator/ => 200 text/html self canonical
- /api/v1/800x450/7C3AED/FFFFFF?text=Placeholder+Image => image/svg+xml

## Requirements *(mandatory)*

### Functional Requirements

- **FR-001**: A canonical `/placeholder-image-generator/` page MUST exist.
- **FR-002**: Metadata and H1/intro MUST target placeholder image generator.
- **FR-003**: The first screen MUST include a usable generator or clearly visible live URL builder.
- **FR-004**: The generator content MUST support size, text, background color, and text color.
- **FR-005**: Generated URLs MUST use `/api/v1/...`.
- **FR-006**: The page MUST include copyable HTML and plain URL examples.
- **FR-007**: The page MUST link to Placeholder Image API, Dummy Image Generator, Docs, and API Reference.
- **FR-008**: The page MUST be included in sitemap with final canonical URL.
- **FR-009**: The page MUST NOT duplicate homepage or Placeholder Image API page content.
...
- **Public URLs**: /placeholder-image-generator/ => 200 text/html self canonical; /api/v1/800x450/7C3AED/FFFFFF?text=Placeholder+Image => image/svg+xml
