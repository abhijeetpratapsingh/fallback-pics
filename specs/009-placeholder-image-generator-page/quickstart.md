# Quickstart Validation: Add Placeholder Image Generator Page
...
```bash
curl -I https://fallback.pics/placeholder-image-generator/
```
```bash
curl -I https://fallback.pics/api/v1/800x450/7C3AED/FFFFFF?text=Placeholder+Image
```
