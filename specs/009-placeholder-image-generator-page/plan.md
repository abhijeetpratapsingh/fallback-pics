# Implementation Plan: Add Placeholder Image Generator Page

**Branch**: `009-placeholder-image-generator-page` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/009-placeholder-image-generator-page/spec.md`

## Summary

Implement placeholder generator page by updating apps/web/src/data/seoPages.ts, apps/web/src/pages/[...slug].astro, apps/web/public/sitemap.xml and validating public URL truth.
...
- **Public URL Truth**: /placeholder-image-generator/ => 200 text/html self canonical; /api/v1/800x450/7C3AED/FFFFFF?text=Placeholder+Image => image/svg+xml. Validation commands are listed in quickstart.md and contracts/http-validation.md.
...
```text
specs/009-placeholder-image-generator-page/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
