# Feature Specification: Normalize Internal Link Trailing Slashes

## Source Story

Source story file: specs/24-normalize-internal-link-trailing-slashes.md

## User Value

Normalize internal HTML links to final trailing-slash URLs while preserving /api/v1 image routes, hash links, and external links.
