# Implementation Plan: Refine Mobile Homepage First Fold

**Branch**: `013-refine-mobile-homepage-first-fold` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/013-refine-mobile-homepage-first-fold/spec.md`

## Summary

Implement refine mobile homepage first fold.
...
- **Public URL Truth**: / at 390x844; / at 1440x1000.
...
```text
specs/013-refine-mobile-homepage-first-fold/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
