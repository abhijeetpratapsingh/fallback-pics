# Feature Specification: Remove FAQPage Schema

## Source Story

Source story file: specs/21-remove-faqpage-schema.md

## User Value

Remove FAQPage and HowTo JSON-LD from commercial SEO pages while preserving visible FAQ content and valid WebPage schema.
