# Feature Specification: Publish llms.txt

**Feature Branch**: `004-publish-llms-txt`

**Created**: 2026-06-03

**Status**: Implemented

**Input**: Source story converted from `specs/04-publish-llms-txt.md`

## User Scenarios & Testing *(mandatory)*

### User Story 1 - Publish llms.txt (Priority: P1)

As an AI search or assistant crawler, I want a concise llms.txt file so that I can understand fallback.pics, its API, docs, and key guides without parsing unrelated homepage HTML.

**Why this priority**: A real text file avoids homepage HTML fallback and gives crawlers stable product context.
...
- **FR-001**: `/llms.txt` MUST be published as a static text file.
- **FR-002**: The file MUST include a short product summary.
- **FR-003**: The file MUST link to homepage, docs, API Reference, GitHub, and primary guides.
- **FR-004**: The file MUST reference placeholder image API, placeholder image generator, dummy image generator, broken image fallback, React image fallback, and Next.js image fallback.
- **FR-005**: The file MUST avoid unsupported claims.
...
- **Public URLs**: /llms.txt => 200 text/plain when deployed by Pages static assets
