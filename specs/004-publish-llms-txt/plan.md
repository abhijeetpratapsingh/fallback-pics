# Implementation Plan: Publish llms.txt

**Branch**: `004-publish-llms-txt` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/004-publish-llms-txt/spec.md`

## Summary

Implement publish llms txt by updating apps/web/public/llms.txt, apps/web/public/robots.txt and validating public URL truth.
...
- **Public URL Truth**: /llms.txt => 200 text/plain when deployed by Pages static assets. Validation commands are listed in quickstart.md and contracts/http-validation.md.
