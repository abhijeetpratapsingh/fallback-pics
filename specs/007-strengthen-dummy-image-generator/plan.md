# Implementation Plan: Strengthen Dummy Image Generator Page

**Branch**: `007-strengthen-dummy-image-generator` | **Date**: 2026-06-03 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/007-strengthen-dummy-image-generator/spec.md`

## Summary

Implement dummy image generator page by updating apps/web/src/data/seoPages.ts, apps/web/src/pages/[...slug].astro, apps/web/src/layouts/ContentLayout.astro and validating public URL truth.
...
- **Public URL Truth**: /dummy-image-generator/ => 200 text/html self canonical; dummy example URLs => /api/v1 image/svg+xml. Validation commands are listed in quickstart.md and contracts/http-validation.md.
...
```text
specs/007-strengthen-dummy-image-generator/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
